              ...
              <div class="row">
                  <div class="col-lg-12">
                      ...
                      <div class="col-md-6 user_image_box">
                        <a data-toggle="modal" data-target="#photo-library" href="#"><img class="img-responsive" src="<?php echo $user->image_path_and_placeholder(); ?>"alt="error"></a>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="first_name" class="form-control" id="firstname" value="<?php echo $user->first_name; ?>">

                        </div>

                        <div class="form-group">
                          <label for="lastname">last Name:</label>
                          <input type="text" name="last_name" class="form-control" id="lastname" value="<?php echo $user->last_name; ?>">
